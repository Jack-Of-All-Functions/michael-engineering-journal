...
2. [Table Basics](#table-basics)
  ...
  2.2. [Dropping a Table](#dropping-a-table)
3. [Modifying Tables](#modifying-tables)
4. [Schemas](#schemas)
5. [Data Manipulation](#data-manipulation)
  5.1. [Inserting Data](#inserting-data)
  5.2. [Updating Data](#updating-data)
  5.3. [Deleting Data](#deleting-data)
  5.4. [Querying a Table](#querying-a-table)
